...
# print(os.getcwd())
path1 = '{}/tests/data/precooked/fixed/local-blast/*'.format(general_wd)
...
# print(fn_path)
filteredScrape.run_local_blast(fn, fn, output=os.path.join(filteredScrape.workdir, "blast/output_{}_tobeblasted.xml".format(fn)))
output_blast = os.path.join(filteredScrape.workdir, "blast/output_{}_tobeblasted.xml".format(fn))
# print("output_blast")
# print(output_blast)
