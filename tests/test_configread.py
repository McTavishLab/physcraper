...
def test_config():
    ...
    if conf.blast_loc != "remote":
        expected_keys = ['seq_len_perc', 'num_threads', 'phylesystem_loc', 'ncbi_parser_names_fn', 'ncbi_parser_nodes_fn', 'maxlen', 'id_pickle', 'hitlist_size', 'gb_id_filename', 'delay', 'unmapped', 'trim_perc', 'url_base', 'ott_ncbi', 'blast_loc', 'add_lower_taxa', 'email', 'e_value_thresh', 'blastdb']
    else:
