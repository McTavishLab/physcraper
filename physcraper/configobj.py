    ...
    def set_local(self):
        ...
        if not os.path.exists("{}/nt.23.nhr".format(self.blastdb)):
            sys.stderr.write("Errors with local Blast DB at {}, \
                ...
                or update as described in 'taxonomy/update_blast_db'\n".format(self.blastdb))
            sys.exit()
        else:
