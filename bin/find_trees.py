...
"""
This module handles the command line code to find trees in the Open Tree of Life
Phylesystem database that contain a biological group of interest and/or that have
data in TREEbase too.
"""
