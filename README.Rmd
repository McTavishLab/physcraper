...
usage,
- finding and choosing a [starting dataset](https://physcraper.readthedocs.io/en/latest/find-trees.html),
- [running](https://physcraper.readthedocs.io/en/latest/run.html) a full analysis,
- [visualizing and analysing](https://physcraper.readthedocs.io/en/latest/results.html) results,
